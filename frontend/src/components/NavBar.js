    ...
    return (
        ...
        >
            ...
            <Nav className="mr-auto">
                <Nav.Link as={Link} to="/prodavci">
                    Prodavci
                </Nav.Link>
            </Nav>

            {TokenService.getToken() ? (
                <Button onClick={() => AuthenticationService.logout()}>Izlogujte se</Button>
            ...
            {TokenService.getToken() ? (
                ...
                <Nav.Link as={Link} to="/registracija-kupac">
